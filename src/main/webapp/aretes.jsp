...
<body>
    ...
    <header>
        <h1>Nuestros Aretes</h1>
    </header>

    <main class="products-container">
        <!-- Producto 1 -->
        <section class="product">
            <img src="https://www.yanbal.com/medias/240Wx240H-Yanbal-OriginalFormat-25038871-01.jpg?context=bWFzdGVyfGltYWdlc3w3MzA0fGltYWdlL2pwZWd8YURReEwyZzRPUzh4TURNMU1qSTVPVGN6TnpFeE9DOHlOREJYZURJME1FaGZXV0Z1WW1Gc0xVOXlhV2RwYm1Gc1JtOXliV0YwWHpJMU1ETTRPRGN4WHpBeExtcHdad3xkNDgxNWU1ZjBhMjA5ZDQ4ZWU5MjlmOTBjMTkwNWIwNzNhNTk3MjBjZjI1YzYwOWM0MTI0MjNhYWYxZGNmNTdl"  width="500" alt="Joyeria Arbolda">
        ...
        <!-- Producto 2 -->
        <section class="product">
            <img src="https://plazavea.vteximg.com.br/arquivos/ids/28581376-1000-1000/imageUrl_1.jpg?v=638388478394000000" width="500" alt="Exfoliante corp">
